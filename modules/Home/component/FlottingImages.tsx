...
const FlottingImages = ({
  ...
  return (
    <div className={cn("absolute z-40 hidden lg:flex pointer-events-none ", className)}>
      <div className="flex flex-col gap-0  ">
        {leftImages.map((image, index) => (
          <motion.img
            ...
            className={`w-[30vh] 2xl:w-[40vh] object-cover rounded-lg bg-white p-1 relative z-[${index + 1}] cursor-pointer pointer-events-auto `}
          />
        ))}
      </div>
      <div className="flex flex-col gap-0  2xl:-ml-0">
        {rightImages.map((image, index) => (
          <motion.img
            ...
            src={image.src}
            alt={image.alt || "images"}
            className={`max-w-[30vh] 2xl:max-w-[40vh] object-cover rounded-lg bg-white p-1 relative z-[${index + 4}] cursor-pointer pointer-events-auto `}
          />
        ))}
      </div>
    </div>
