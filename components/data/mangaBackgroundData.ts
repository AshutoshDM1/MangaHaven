...
export const mangaBackgroundData: MangaBackground[] = [
    {
        ...
        title: "One Punch Man",
        description: "One Punch Man tells the story of Saitama, a superhero who can defeat any opponent with a single punch but seeks to find a worthy opponent after growing bored by a lack of challenge due to his overwhelming strength. The series follows Saitama and his disciple Genos as they join the Hero Association to gain official recognition as heroes, meeting various other heroes and villains along the way. As Saitama faces increasingly powerful opponents, he struggles with the crisis of being too powerful, often ending fights with a single punch, much to his disappointment.",
        chapter: "Chapter 123",
        volume: "Volume 23",
        status: "Ongoing"
    },
