...
const MangaCarousel: React.FC = () => {
  ...
  return ( 
    <div className="relative w-full overflow-visible p-4 lg:px-4 md:px-8 sm:px-12">
      ...
      <button
        onClick={prevSlide}
        className="absolute lg:left-[-2%] md:left-0 sm:left-[3%] left-[1%] md:h-[25.1vh] sm:h-[20.3vh] sm:rounded-r-3xl sm:w-auto w-4 md:top-[28.5%] sm:top-[25%] top-[55%] transform -translate-y-1 shadow-md bg-[#a962ff] bg-opacity-70 lg:p-2 md:p-1 z-10 flex justify-start items-center hover:bg-opacity-100 transition-all duration-300 rounded-full w-13 h-7"
      >
      ...
      <button
        onClick={nextSlide}
        className="absolute lg:right-[-2%] md:right-0 sm:right-[3%] right-[1%] md:h-[25.1vh] sm:h-[20.3vh] sm:rounded-l-3xl sm:w-auto w-4 md:top-[28.5%] sm:top-[25%] top-[55%] transform -translate-y-1 shadow-md bg-[#a962ff] bg-opacity-70 lg:p-2 md:p-1 z-10 flex justify-end items-center hover:bg-opacity-100 transition-all duration-300 rounded-full w-13 h-7"
      >
